// dns = domin name system (server)

const dns = require('dns')

dns.lookup('www.be-practicals.com', function(err,address,family) {
    if(err) throw err;
...
// service = ssh (secure shell /secure socket shell) -> network protocal

// www.br-practicals.com
